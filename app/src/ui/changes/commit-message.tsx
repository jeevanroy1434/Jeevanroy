...
// https://primer.style/foundations/icons/sparkles-fill-16
const suggestCommitMessageIcon: OcticonSymbolVariant = {
  w: 16,
  h: 16,
  p: [
    'M9.6 2.279a.426.426 0 0 1 .8 0l.407 1.112a6.386 6.386 0 0 0 3.802 3.802l1.112.407a.426.426 0 0 1 0 .8l-1.112.407a6.386 6.386 0 0 0-3.802 3.802l-.407 1.112a.426.426 0 0 1-.8 0l-.407-1.112a6.386 6.386 0 0 0-3.802-3.802L4.279 8.4a.426.426 0 0 1 0-.8l1.112-.407a6.386 6.386 0 0 0 3.802-3.802L9.6 2.279Zm-4.267 8.837a.178.178 0 0 1 .334 0l.169.464a2.662 2.662 0 0 0 1.584 1.584l.464.169a.178.178 0 0 1 0 .334l-.464.169a2.662 2.662 0 0 0-1.584 1.584l-.169.464a.178.178 0 0 1-.334 0l-.169-.464a2.662 2.662 0 0 0-1.584-1.584l-.464-.169a.178.178 0 0 1 0-.334l.464-.169a2.662 2.662 0 0 0 1.584-1.584l.169-.464ZM2.8.14a.213.213 0 0 1 .4 0l.203.556a3.2 3.2 0 0 0 1.901 1.901l.556.203a.213.213 0 0 1 0 .4l-.556.203a3.2 3.2 0 0 0-1.901 1.901L3.2 5.86a.213.213 0 0 1-.4 0l-.203-.556A3.2 3.2 0 0 0 .696 3.403L.14 3.2a.213.213 0 0 1 0-.4l.556-.203A3.2 3.2 0 0 0 2.597.696L2.8.14Z',
  ],
}
...
> {
  ...
  private get toggleSuggestCommitMessageText(): string {
    return __DARWIN__ ? 'Suggest Commit Message' : 'suggest commit message'
  }
  ...
  private renderSuggestCommitMessageButton() {
    if (this.props.repository.gitHubRepository === null) {
      return null
    }
    ...
    return (
      <Button
        ...
        disabled={this.props.isCommitting === true}
      >
        <Octicon symbol={suggestCommitMessageIcon} />
      </Button>
    )
  }
  ...
  private renderActionBar() {
    ...
    return (
      <div className={className}>
        ...
        {this.renderSuggestCommitMessageButton()}
      </div>
    )
  }
