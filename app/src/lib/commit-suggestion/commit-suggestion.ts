...
async function generateCommitSuggestion(
  ...
  const prompt = `Analyze the provided Git diffs and generate a JSON object with the structure below. DO NOT include any other text or explanation. The JSON object should STRICTLY follow this format:
    ...
    4. 'body': Provide a detailed explanation of what the change entails and why it was necessary. Include any relevant context or rationale for the change. Do not include any additional or extraneous information.
